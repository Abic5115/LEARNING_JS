...
function changename() {
     ...
     document.getElementById("b1").innerHTML="name changed successfully"
...
function changeaddress() {
    document.getElementById("b3").style.background="red"
     document.getElementById("b3").innerHTML="address changed successfully"
...
function addsubjectandmark() {
    document.getElementById("b4").style.background="red"
     document.getElementById("b4").innerHTML="subject added successfully"
...
function removesubject() {
    ...
    document.getElementById("b5").style.background="red"
     document.getElementById("b5").innerHTML="subject removed successfully"
...
function changemark() {
    document.getElementById("b6").style.background="red"
     document.getElementById("b6").innerHTML="mark changed successfully"
...
function Displayallmark() {
    document.getElementById("b7").style.background="red"
     document.getElementById("b7").innerHTML="displayed mark"
...
function scholarshipstatus() {
    document.getElementById("b8").style.background="red"
     document.getElementById("b8").innerHTML="scholarship status updated"
...
function addage() {
     document.getElementById("b9").style.background="red"
...
function totalmark() {
     document.getElementById("b10").style.background="red"
